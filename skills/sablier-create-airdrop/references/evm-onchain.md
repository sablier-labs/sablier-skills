...
MerkleLL and MerkleLT campaigns use percentage-based types from the PRBMath library: `UD60x18` (`uint256`, `1e18` = 100%) for MerkleLL, and `UD2x18` (`uint64`, `1e18` = 100%) for MerkleLT tranche percentages.
